...
/**
 * MenuUserWidget provides a user interface for the player to modify game settings
 */
UCLASS()
class PROJECT_API UMenuUserWidget : public UUserWidget
{
	GENERATED_BODY()
...
protected:
	...
	UWidgetAnimation* SettingsPanelAnimation;
